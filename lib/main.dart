...
class _MyBottomNavigationBarState extends State<MyBottomNavigationBar> {
  int _currentIndex=3;
  final List<Widget> _children=[Settings(),null,Medications(),Home()]; //bottom navigation bar calls


  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body:_children[_currentIndex], //set to index 3 initially to show Home page
